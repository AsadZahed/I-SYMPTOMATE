                        ...
                        <img src={scan ? `http://localhost:9000/${scan.filename}` : ''} alt='Skin Cancer Scan' className='scan' /> */}
                            ...
                            <div className='float-container' style={{border:"1px solid black"}}>
                                <div class="float-child">
                                    ...
                                    <img src={scan ? `http://localhost:9000/${scan.filename}` : ''} alt='Respiratory Scan' style={{ height: '150px', width: '200px' }} />
                                </div>
                            </div>
                            </form>
                            <form>
                         ...
                         {show === true ?   <Button
                            ...
                            </Button> : <Alert variant="danger" style={{fontSize:"20px",textAlign:"center"}}><b>Because you are diagnosing someone's disease that's why no report generation is available</b></Alert>
}
                        </div>
                    </div>
                </div>
