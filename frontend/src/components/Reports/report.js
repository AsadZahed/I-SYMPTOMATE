...
export default function Report() {
  ...
  const checkdiseases = () => {
    ...
    else if (cancer[0] === 'Basal cell carcinoma') {
    ...
    else if (cancer[0] === "Benign keratosis-like lesions") {
    ...
    else if (cancer[0] === "Dermatofibroma") {
    ...
    else if (cancer[0] === "Melanocytic nevi") {
    ...
    else if (cancer[0] === "Actinic keratoses") {
    ...
    else if (cancer[0] === "Vascular lesions") {
      ...
      return (
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p>
                {cancer[0] === "Pneumonia" ? (<li>Pneumonia is an infection that inflames your lungs' air sacs (alveoli). The air sacs may fill up with fluid or pus, causing symptoms such as a cough, fever, chills and trouble breathing.</li>):(<li>Your Xray is Normal.</li>)}
                {cancer[0] === "Pneumonia" ? (<li>In the Image you can see the White cloudiness near lungs, this shows Xray given has Pneumonia.</li>):console.log("")}
              </p>
            </li>
          </ul>
        </div>
            ...
            >
              ...
              >
                <p style={{ fontSize: "20px", fontWeight: "500", paddingTop: "50px" }}>
                  Screening Result: <i><u><b>{cancer[0]}</b></u></i>
                </p>
                <img
                  src={i}
