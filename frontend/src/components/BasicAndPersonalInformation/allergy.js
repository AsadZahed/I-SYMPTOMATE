...
function Question() {
  ...
  function handleSubmit(event) {
    ...
    axios
      .post("http://localhost:9000/addinfo/allergy", data, {
        headers: {
                  ...
                  <div className="btn-toolbar">
                    ...
                    q5 === "" ? (
                      <Alert variant="danger">
                        Please Select <b>One</b> option from every question
                      </Alert>
                    ) : (
