...
import signupgif from "../../components/images/signup.gif";
import signingif from "../../components/images/signin.gif";
import skingif from "../../components/images/skincheck.gif";
import respgif from "../../components/images/respcheck.gif";
import reportgif from "../../components/images/checkreport.gif";
import sympgif from "../../components/images/symptomatic.gif";
      ...
      <div style={{ backgroundColor: '#F8F8F8' }}>
        ...
        >
          ...
          >
            <COffcanvasHeader>
              <COffcanvasTitle>
                <h1 style={{ fontWeight: 'bold' }}>Tutorial</h1>
              </COffcanvasTitle>
              <CCloseButton
            ...
            <COffcanvasBody >
              {visible ? (
                <div>
                  ...
                  <img src={signupgif} alt="loading..." style={{width:"80%"}} />
                  <Link
                    style={{ color: '#0c0530' }}
                    to={{
              ...
              <div style={{ padding: '3%' }}>
                ...
                >
                  <h5 style={{ color: '#0047b3', textDecoration: 'none' }}>
                    ...
                    <b>How to Register into Intelligent Symptomate</b>,
                    <br />
                  </h5>
                </Button>
              </div>
